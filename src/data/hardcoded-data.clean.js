...
export const petAbilities = {
  ...
  // used by turkey: EggGrowthBoostII_NEW
  ...
  // former EggGrowthBoostIII replaced by this block
  EggGrowthBoostII: {
...
export const weatherCatalog = {
  Rain: {
    ...
    notes: ['Primary vs Snow (75%)', 'Applies to a random applicable crop']},
  Frost: {
    atomValue:'Frost',
    ...
    notes: ['Secondary vs Rain (25%)', 'Frozen recommended for mushroom/cactus/bamboo']},
  Sunny: {
    atomValue:null,
